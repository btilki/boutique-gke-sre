...
| -------------------------------------------------------- | ----- | ----------------------------------------------------------------------------- |
| [ci.yml](ci.yml)                                         | 1+    | Terraform validate, **runbook-lint**, Kyverno tests, digest-only, kubeconform |
...
| [../ISSUE_TEMPLATE/](../ISSUE_TEMPLATE/)                   | Bug, incident follow-up, error-budget freeze |
