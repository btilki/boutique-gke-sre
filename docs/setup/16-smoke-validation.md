...
![Argo CD Applications — all Synced and Healthy](../../assets/diagrams/argocd-applications-healthy-synced.png)
...
| ----------- | -------------------------------------------------------------------------------------------------------------- | ----------- |
| Storefront  | [boutique-storefront-https.png](../../assets/diagrams/boutique-storefront-https.png)                           | 12, 16      |
| GitOps      | [argocd-applications-healthy-synced.png](../../assets/diagrams/argocd-applications-healthy-synced.png)         | 16          |
| CI pipeline | [github-actions-build-scan-sign-success.png](../../assets/diagrams/github-actions-build-scan-sign-success.png) | 12          |
| PagerDuty   | [pagerduty-service-events-api-v2.png](../../assets/diagrams/pagerduty-service-events-api-v2.png)               | 14          |
