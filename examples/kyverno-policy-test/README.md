...
| `bad-missing-netpol-label-ns.yaml` | `require-netpol-labels` | `require-netpol-tier-label`           | Namespace missing tier label  |
| `bad-plain-secret.yaml`            | `block-plain-secrets`   | `block-secret-create`                 | Plain Secret in app namespace |
